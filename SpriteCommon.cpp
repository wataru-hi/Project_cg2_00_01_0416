...
void SpriteCommon::CreateRootSignature()
{
	...
	descripionRootSignature.Flags = D3D12_ROOT_SIGNATURE_FLAG_ALLOW_INPUT_ASSEMBLER_INPUT_LAYOUT;
	...
	HRESULT hr = D3D12SerializeRootSignature(&descripionRootSignature, D3D_ROOT_SIGNATURE_VERSION_1, &signatureBlob, &errorBlob);
	if (FAILED(hr)) {
