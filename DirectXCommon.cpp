...
void DirectXCommon::SetCompileVertexShader(const std::wstring& filePath, const wchar_t* profile)
{
	vertexShaderBlob = CompileShader(filePath,profile);
	assert(vertexShaderBlob != nullptr);
}

void DirectXCommon::SetCompilePixcelShader(const std::wstring& filePath, const wchar_t* profile)
{
...
void DirectXCommon::SetDescriptorRange()
{
...
void DirectXCommon::SetInputElementDesc()
{
...
void DirectXCommon::SetRasterizerState() {
    
    rasterizerDesc.CullMode = D3D12_CULL_MODE_NONE;
    rasterizerDesc.FillMode = D3D12_FILL_MODE_SOLID;
}

void DirectXCommon::CreateGraphicsPipelineState() {
